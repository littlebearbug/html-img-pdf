...
type PageSizePreset = "a4" | "letter" | "legal" | "a3" | "a5";
...
declare function htmlToPdf(element: HTMLElement, options?: Options): Promise<jsPDF>;

export { type CaptureResult, type CustomPageSize, type Options, type PageOrientation, type PageSizePreset, htmlToPdf };
